...
Simplify the fraction $\displaystyle \frac{4}{12}$ using the GCF = $4.$
...
\begin{problem}
  Simplify the fraction $\displaystyle \frac{24}{36}$ using the GCF = $12.$
...
\begin{problem}
  Follow the steps below to simplify the fraction $\displaystyle \frac{18}{45}.$

  \begin{enumerate}
  \item Find the Greatest Common Factor (GCF) of 18 and 45.

  \[ \textrm{GCF} = \answer{9}  \]

  
  \item Divide both the numerator and the denominator by the GCF to simplify.
...
\begin{enumerate}
  \item Write the prime factorization of the numbers in the numerator and denominator.  

  \item Cancel (divide out) the common factors that appear in both the the numerator and denominator.

  \item Multiply the remaining numbers in the numerator and denominator to find the result.
...
\begin{remark}
To \textbf{cancel} or divide out means that we remove the common factors, since their quotient is 1.
\end{remark}

\begin{example}
  
Simplify the fraction $\displaystyle \frac{20}{25}$ using prime factorizations.

\begin{explanation}

Begin by writing the prime factorizations of 20 in the numerator and 25 in the denominator.  Since there is a common 
factor of 5 in the numerator and denominator, we can cancel or divide out the fives since $\frac{5}{5}=1.$  Finally, we
multiply the remaining numbers in the numerator and denominator to find the result. 

\begin{align*}
\frac{20}{25} &= \frac{2 \cdot 2 \cdot 5}{5 \cdot 5} \\[1em]
              &= \frac{2 \cdot 2 \cdot \cancel{5}}{5 \cdot \cancel{5}} \\[1em]
              &= \frac{ \answer{4}}{ \answer{5} }
\end{align*}
...
\begin{hint}
  ...
  \begin{hint}
    If you want to use the Greatest Common Factor (GCF) to simplify, the factors of $33$ are $1, 3, 11, 33.$  The largest factor
    that evenly divides into $60$ is the GCF.  
  \end{hint}
...
\begin{problem}
  ...
  \begin{hint}
    If you want to use the Greatest Common Factor (GCF) to simplify, the factors of $60$ are $1, 2, 3, 4, 5, 6, 10, 12, 15, 20, 30, 60.$  The
    largest factor that evenly divides into $126$ is the GCF. 
  \end{hint}
...
\begin{problem}
  ...
  only $21$ tons could be recycled.  What \textbf{fraction} of the collected plastic was recycled?  \textbf{Remember to simplify your answer, if possible}.

  \[ \text{Fraction Recycled} = \frac{\answer{7}}{\answer{18}} \]

  \begin{hint}
    Write the fraction as the amount recycled over the total amount collected, then simplify.
...
\textbf{Remember to simplify your answer, if possible}.
