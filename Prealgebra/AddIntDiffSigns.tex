...
\textcolor{orange!80!black}{\textbf{Battle 1:}}  \ If you have \$30 and spend \$20 to see a movie, your net balance is \$10. 

\[ 30 + (-20) = 10 \]

\textcolor{glaucous}{\textbf{The answer is positive, so the positive team win!}}


\textcolor{orange!80!black}{\textbf{Battle 2:}} \ If you have \$30 and a credit card debt of \$100, your net balance is a debt of \$70.


\[ 30 + (-100) = -70 \]

\textcolor{glaucous}{\textbf{The answer is negative, so the negative team win!}}

\textbf{Why did the positive team win the first battle and lose the second battle?}

The positive team won the first battle because the asset was greater than the debt, but 
lost the second because the debt was greater than the asset.  In any number battle, the winner is always 
the team with the \textbf{greatest strength}, regardless of its sign.  Mathematically, we find the \textbf{absolute value} 
of a number to determine its \textbf{magnitude}, \textbf{strength} or \textbf{size}.  


\textcolor{orange!80!black}{\textbf{Battle 1:}} \ $30 + (-20) = 10$  
\begin{itemize}
...
\textcolor{orange!80!black}{\textbf{Battle 2:}} \ $30 + (-100) = -70$
\begin{itemize}
    \item[] The strength of the \$30 asset is $|30| = 30$.
...
has the greatest strength.  To turn these observations into a formal rule, we use absolute value.
...
\begin{example} 
    ...
    \begin{description}[style=multiline, leftmargin=5em, font=\bfseries]
        ...
        \item[Step 3:] \textbf{Declare the Winner and Write the Answer (The Sign)} \\
...
\begin{problem}
    ...
    \textbf{Step 3:} \textbf{Declare the Winner and Write the Answer (The Sign)}
