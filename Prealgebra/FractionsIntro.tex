...
% Alt Text
\xmalt{Two squares side-by-side. The left square is a 2x2 grid with the two left quadrants shaded blue. The right square is 
divided vertically with the left half shaded blue. They are separated by an equal sign.}
...
% alt tex
 \xmalt{The image shows a circle divided into six equal wedge-shaped sections. Two adjacent sections on the upper-left are shaded blue.} 
 %Below are three multiple-choice options, each with a labeled circle:
