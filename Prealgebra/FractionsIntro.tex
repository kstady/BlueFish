...
\begin{explanation}
Since the denominator is 4, we divide the distance from 0 to 1 into 4 equal parts.  Then we start at 0 and move 3 parts to 
...
\begin{explanation}
Since the denominator is 5, divide the distance between the whole numbers 2 and 3 into 5 equal parts.  Then start at 2 and move 1 part to the right.
