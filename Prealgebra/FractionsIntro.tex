...
% Alt Text
\xmalt{Two squares side-by-side, as described above, separated by an equal sign.}
...
% Alt Text
\xmalt{A horizontal number line labeled with the whole numbers 0, 1, 2, and 3. The segment between 2 and 3 is divided into five equal parts by 
