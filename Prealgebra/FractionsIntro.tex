...
\begin{tikzpicture}[>=stealth]
        ...
        \draw[thick, <->] (0,0)--(6,0) node at (1,-0.3) {\small 0} node at (5, -0.3) {\small 1} node at (4,-0.5) { $\frac{3}{4}$};
...
\begin{problem}
Identify the position of the letter $B$ on the number line.**************************************emlimated small font on  0 1 2 on num line

~ \\[3em]

\begin{center}
\begin{tikzpicture}[>=stealth]
        \draw[thick, <->] (0.5,0)--(9.5,0) node at (1,-0.3)  {0} node at (5, -0.3) {1} node at (9, -0.3) {2} node at
        (8.5, 0.3) {\textbf{B}};
