...
The negative sign is omitted in the phrase because the word \emph{debt} implies a negative value.
\end{remark}

\begin{example}  \textcolor{accessibleOrange}{\textbf{Combining Assets}} 
    
    If a child has $\$100$ ($+100$) in her piggy bank and receives $\$30 (+30)$ for doing her chores, her net 
     balance is $\mathbf{\$130}.$

    \[ 100 + 30 = 130 \]
\end{example}

\begin{example} \textcolor{accessibleOrange}{\textbf{Combining Debts}} 
    
    If you have a credit card debt of $\$500$ ($-500$) and make another credit card purchase of 
    $\$100$ ($-100$), your net balance is a \textbf{debt} of $\mathbf{\$600}$ $(-600)$.
    \[ -500 + (-100) = -600 \]
\end{example}

\begin{example} \textcolor{accessibleOrange}{\textbf{Partial Cancellation}}  
    ...
    your net balance is a \textbf{debt} of $\mathbf{\$5}$ ($-5$).
    \[ 20 + (-25) = -5 \]
\end{example}

\begin{example} \textcolor{accessibleOrange}{\textbf{Full Cancellation}} 
    
    If a taxpayer \textbf{owes} the IRS $\$300$ ($-300$) and has $\$800$ ($+800$) in the bank, they can pay the 
    entire debt and keep the change.  Their net balance is $\mathbf{\$500}$ ($+500$).
    \[ -300 + 800 = 500 \]
\end{example}
...
\begin{itemize}
    \item[] \textbf{Same Signs}: \ When we add two assets or two debts, we \textbf{add} their absolute values.  The sign of 
    the answer is the same as the sign of the numbers.
...
net balance.  Then calculate your net balance.  \textbf{If the net balance is a debt, use a negative sign in your answer}. 
...
\textcolor{accessibleOrange}{\textbf{Net Balance}} = $\answer{-65}$
...
the team's net balance.  Then calculate their net balance.  \textbf{If the net balance is a debt, use a negative sign in your answer}. 
...
\textcolor{accessibleOrange}{\textbf{Net Balance}} = $\answer{150}$
...
find your net balance after you use your gift money toward the rent.  Then calculate your net balance.  \textbf{If the net balance is a debt, 
use a negative sign in your answer}.
...
\textcolor{accessibleOrange}{\textbf{Net Balance}} = $\answer{-200}$
