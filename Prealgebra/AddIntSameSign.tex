...
\title{Adding Integers: Same Signs}   % Use xmlatex ghaction or xmlatex all -s to compile when SERVE refuses to work.
\author{Kelly Stady}
...
\begin{example} \textcolor{accessibleOrange}{\textbf{Joining Assets}}

If you have $\$400$ in your savings account ($+400$) and you win $\$150$ ($+150$), you have a net balance of \textbf{\$550.}
\[ 400 + 150 = 550 \]

\end{example}

\begin{example} \textcolor{accessibleOrange}{\textbf{Joining Debts}}

If you owe your brother $\$10$ ($-10$) and then borrow another $\$25$ ($-25$), your net balance is a \textbf{debt} of $\mathbf{\$35.}$ 
...
\begin{explanation}
    ...
    \[ |-50| = \answer{50} \quad \text{and} \quad |30| = \answer{30} \]
...
\begin{problem}  
You add a $\$20$ credit ($+20$) to your gaming account and later add another $\$15$ credit ($+15$). Find your net balance.
...
\begin{problem}
An activist is arrested at a peaceful protest.  A commercial bail bondsman charges a non-refundable $\$500$ premium ($-500$) to secure their release.  
Because the activist cannot pay upfront, the bondsman adds a $\$150$ financing fee ($-150$) to the debt. Find the activist's net balance.
...
On the very next play, he charged forward an additional $2$ yards.  Find the total number of yards 
gained by the running back over these two plays.

\[ 6 + 2 = \answer{8} \ \textrm{yards} \]

\end{problem}


\begin{problem}
A research submarine is exploring the ocean floor.  It starts recording at a depth of $5$ meters below sea level.  The pilot then 
navigates the submarine down another $8$ meters.  Find the submarine's final depth relative to sea level.

\[ -5 + (-8) = \answer{-13} \ \textrm{meters} \]
...
hours, another cold front moved through the area and the temperature dropped by $5^\circ\text{F}.$  Find the 
temperature at 3am.

\[ -1 + (-5) = \answer{-6} \ ^\circ\text{F} \]
\end{problem}
