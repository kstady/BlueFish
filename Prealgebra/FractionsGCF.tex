...
\begin{problem} \textcolor{accessibleOrange}{\textbf{True or False}}  The GCF will always be less than or equal to the smallest 
    number in the group.
...
\begin{problem}
  ...
  \begin{hint}
    Divide the number of each candy by the number of bags.  For example, $18 \div 6 = 3$ Airheads.
  \end{hint}
...
\begin{problem}
  A carpenter has three wooden boards of different lengths: $8$ ft, $12$ ft and
      $20$ ft.  The carpenter wants to cut all three boards into smaller pieces of equal length,
  ...
  \begin{hint}
    Find the GCF of 8, 12, and 20.  This is largest number that divides evenly into all three lengths and is therefore the longest length.
  \end{hint}
...
How many pieces will the carpenter have after cutting all three boards?
  ...
  \begin{hint}
    Divide each board's length by the GCF to see how many pieces come from each board, then add them.
  \end{hint}
\end{problem}
