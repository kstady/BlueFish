...
In the ``Setup'' section, on the left, five blue bars represent $-5$ and below are three orange bars representing 3. 
...
We begin with \textcolor{blue!70!black}{\textbf{four blue rods}} to represent the number $-4$ and 
\textcolor{blue!70!black}{\textbf{three blue rods}} to represent the number $-3.$  
...
% --- SETUP  ---   
        ...
        \node[font=\bfseries, blue!80!black, anchor=east] at (-0.2, 1.0) {$-4$};
        ...
        \foreach \x in {0, 0.4, 0.8}
            \draw[line width=2.5pt, blue!80!black, cap=round] (\x, -0.8) -- (\x, 0.2);
