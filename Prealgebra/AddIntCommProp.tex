...
\textcolor{black!75!gray}{\textbf{Find the final sum:}} $\answer{-5}$
\end{problem}
...
\textcolor{black!75!gray}{\textbf{Find the final sum:}} $\answer{300}$
\end{problem}
...
In the morning, they receive a corporate donation of $\$400$ ($+400$).  In the afternoon, they spend $\$150$ on purchasing fresh produce for families in need ($-150$). 
...
Which of the following equations correctly demonstrates this property?

\begin{multipleChoice}
    \choice[correct]{$400 + (-150) = -150 + 400$}
    \choice{$400 + (-150) = 400 + 150$}
    \choice{$400 + (-150) = 150 + 400 $}
    \choice{$400 + (-150) = -150 + (-400)}
\end{multipleChoice}

\textcolor{black!75!gray}{\textbf{Find the organization's final balance:}} $\answer{250}$ \text{ dollars}
\end{problem}
