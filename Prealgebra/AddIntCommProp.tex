...
\begin{problem}
A local grassroots organization hosts a community fundraiser to support a local food bank.  In the morning, they receive a corporate donation of $\$400$ ($+400$). 
In the afternoon, they spend $\$150$ on purchasing fresh produce for families in need ($-150$).  According to the \textbf{Commutative Property of Addition}, changing 
the order of these transactions will not alter the organization's final balance.  Which of the following equations correctly demonstrates this property by showing 
that the afternoon transaction was counted first?
...
\begin{remark}
Once you have mastered these addition rules, you will be ready for subtraction.  As you will see, 
if you can add integers, you can subtract them too!
\end{remark}
