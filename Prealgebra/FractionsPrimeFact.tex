...
$\begin{aligned}
& \textrm{Counting Numbers:} \ \{1, 2, 3, \dots\} \\[1.5ex]
& \textrm{Whole Numbers:} \ \{0, 1, 2, 3, \dots\}
\end{aligned}$
\end{flushleft}
...
\begin{definition}[\textbf{Prime and Composite Numbers}]
...
A counting number greater than 1 that's not prime is called a \textbf{composite number}.

\end{definition}

The first several prime numbers are 2, 3, 5, 7, 11, 13, 17, 19, 23 and 29.  
...
\begin{problem}  \textcolor{accessibleOrange}{\textbf{True or False}} \  All prime numbers are odd, except for 2.
...
and there is even a cash prize for the person who finds the next one.
