...
used for \textbf{grouping}, whereas \textbf{absolute value} is an \textbf{operation}.  Make certain you 
...
\begin{itemize}[leftmargin=0pt]
    ...
    To find the opposite of the absolute value of negative $7,$ start with the absolute value: 
    \[ - \underbrace{|-7|}_{7} = -7 \]
    Then find the opposite of that result. The opposite of $7$ is $-7.$
\end{itemize}



\begin{description}[style=nextline, leftmargin=0pt]  %leftmargin removes the indentation below items
    \item[Double Negative with Parentheses]  Since we have parentheses, we simply find the opposite of negative $7,$ which is $7.$
        \[ -(-7) = 7 \]

\item[Double Negative with Absolute Value]

To find the opposite of the absolute value of negative $7,$ start with the absolute value: $|-7| = 7,$ 
then find the opposite of that result.  The opposite of $7$ is $-7$ therefore,
...
\begin{problem}
\textcolor{orange!80!black}{\textbf{True or False}} \ If a number is negative, its opposite must be positive.
...
\begin{problem}
\textcolor{orange!80!black}{\textbf{True or False}} \ Two different numbers can have the same absolute value.
