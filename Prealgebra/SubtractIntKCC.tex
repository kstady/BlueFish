...
\begin{itemize}
    \item \textbf{KEEP} the first number: $\answer{-8}$
    \item \textbf{CHANGE} the subtraction to addition: $\answer[format=string]{+}$
    \item \textbf{CHANGE} the sign of the second number: $\answer{10}$
\end{itemize}
