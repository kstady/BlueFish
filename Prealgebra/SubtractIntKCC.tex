...
\begin{remark}
    The rules for adding and subtracting integers apply to all real numbers. The integers, along with the fractions and 
    decimals between them make up the set of \textbf{real numbers}.  So, we can apply these rules to add and subtract fractions 
    and decimals.   
\end{remark}
