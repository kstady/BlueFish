...
\begin{problem}
Is the operation of subtraction commutative?  In other words, can we changing the order of the numbers in a subtraction problem and still get the same result?
...
\begin{feedback}
Subtraction is \textbf{not} commutative because swapping the order of the numbers changes the sign of the final answer.  For example, 
\[ 10 - 4 = 6 \]
...
\begin{remark}
    The rules for adding and subtracting integers apply to all real numbers. The integers, along with the fractions and decimals between them make up the set of real numbers.
\end{remark}
