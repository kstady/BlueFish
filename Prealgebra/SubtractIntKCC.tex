...
\begin{remark}
    The rules for adding and subtracting integers apply to all \textbf{real numbers}. The integers, along with the fractions and decimals between them make up the set of real numbers.
\end{remark}
