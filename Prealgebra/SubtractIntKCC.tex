...
\textcolor{glaucous!65!black}{\textbf{Answer}} = $\answer{2}$ 

\definecolor{accessibleGlaucous}{HTML}{3B5E91} 
\textcolor{accessibleGlaucous}{\textbf{Answer} = $\answer{-70}$}


\definecolor{ximeraRed}{HTML}{D9534F}
\textcolor{ximeraRed}{\textbf{Answer}} = $\answer{2}$
