...
List the multiples of 4 and 7 as shown below.  Since 28 is the smallest number that appears in \textit{both} lists, the LCD = 28.  
...
$\frac{3}{4} + \frac{1}{7} = \frac{\answer{25}}{\answer{28}} $ 
\end{problem}
