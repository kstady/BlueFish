...
\title{Adding Integers: Numberline}    % Use xmlatex ghaction or all -s to compile when SERVE refuses to work.
\author{Kelly Stady}
...
\node[color=accessibleGreen] at (3,-0.65) {\large \textbf{Start}};
\node[accessibleRed] at (10,-0.65) {\large \textbf{Stop}};
...
\begin{tikzpicture}[x=0.75cm,>=latex, scale=1.5] % Use latex arrowhead style
    ...
    \node[accessibleGreen] at (3,-0.65) {\large \textbf{Start}};
    \node[accessibleRed] at (-4,-0.65) {\large \textbf{Stop}};
