...
represent \textcolor{orange!85!black}{\textbf{positive numbers +}} and \textcolor{blue!70!black}{\textbf{blue rods --}} to represent \textcolor{blue!70!black}{\textbf{negative numbers}}.
...
\begin{center}
\begin{tikzpicture}[scale=0.75, font=\sffamily, >=Latex] % >=Latex for nice arrows 
...
To find the sum $-4+(-3),$ begin with \textcolor{blue!70!black}{\textbf{four blue rods}} to represent the number $-4$ and \textcolor{blue!70!black}{\textbf{three blue rods}} to represent the number $-3.$  Since there are no orange-blue pairs to remove, 7 blue rods remain, so the answer is $-7.$
