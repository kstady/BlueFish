...
\end{tikzpicture}
% Alt text 
\xmalt{The `Setup' showing five blue vertical bars to represent $-5$ and below are three orange vertical bars representing $3.$}
\end{center}
...
\end{tikzpicture}
% Alt text 
\xmalt{A visual representation of the addition problem $-5$ plus $3$ equals $-2$ using a three-step model. 
In the `Setup' section, on the left, five blue vertical bars represent $-5$ and below are three orange vertical bars representing 3. 
...
sum. The `Sum' section shows the two remaining blue bars.}
...
\end{tikzpicture}
% Alt text 
\xmalt{The `Setup' showing four blue vertical bars to represent $-4$ and below are three blue vertical bars representing $-3.$}
\end{center}
...
\end{tikzpicture}
% Alt text 
\xmalt{A visual representation of adding $-4$ and $-3.$
In the `Setup' section, on the left, there are four blue vertical bars to represent $-4$ and below are three blue vertical bars representing $-3.$
The `Remove Pairs' section, in the middle, is the same as the 'Setup' section.  A caption below the rods reads ``No Pairs to Remove!" 
because all rods are the same color. A black arrow points to the `Sum' section, which shows all blue rods together.}
\end{center}
...
\begin{example} Find the sum $-5+3$ using a plus sign $(+)$ for $1$ and a minus sign $(-)$ for $-1.$
...
\end{tikzpicture}
% Alt Text 
\xmalt{A visual representation of adding $-5$ and $3.$  In the `Setup' section, on the left, five minus signs represent 
$-5$ and below three plus signs represent $3.$  In the `Remove Pairs' section, in the middle, three minus signs and three plus signs are 
grouped inside a dashed box to show that they cancel.  Two minus signs remain outside the box.  A black arrow points to the sum.  The `Sum' 
section shows two minus signs labeled $-2$ below.}
\end{center}
