...
\end{tikzpicture}
% Alt text 
\xmalt{The `Setup' showing five blue vertical bars to represent $-5$ and three orange vertical bars to represent $3.$}
\end{center}
...
In the `Setup' section, five blue vertical bars represent $-5$ and three orange vertical bars represent 3. 
In the `Remove Pairs' section, the three orange bars are paired vertically with three of the blue bars 
inside a dashed box to show they cancel each other out, leaving two blue bars outside the box. 
The final `Sum' section shows only the two remaining blue vertical bars.}
...
\end{tikzpicture}
% Alt text 
\xmalt{A visual representation of the addition problem $-4$ plus $-3,$ using a 3-step model. 
In the `Setup' section the number $-4$ is represented by four blue rods and below it the number $-3$ is represented by three blue rods.}
\end{center}
...
\end{tikzpicture}
% Alt text 
\xmalt{A visual representation of adding two negative numbers, $-4$ and $-3,$ using a 3-step model. In the `Setup' section, the number $-4$ is 
represented by four blue rods and below it the number $-3$ is represented by three blue rods. The `Remove Pairs' section is the same as the 
'Setup' section.  A caption below the rods reads ``No Pairs to Remove!" because all rods are the same color. An arrow points to the `Sum' 
section, which displays all blue rods together.}
\end{center}
