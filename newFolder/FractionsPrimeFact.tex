...
Before we can simplify fractions, we first need to understand some concepts involving \textbf{counting numbers} (also called \textbf{natural numbers}) 
...
\textbf{Note}: In the figures below, each composite number is written inside a square for clarity.  You can omit
