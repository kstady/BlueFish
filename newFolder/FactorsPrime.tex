...
\title{Fractions: Factors and Prime Numbers}   % Use xmlatex all -s to compile when SERVE refuses to work.
\author{Kelly Stady}
...
\begin{problem}  \textcolor{glaucous!55!black}{\textbf{True or False}}: \  All prime numbers are odd, except for 2.
