...
\begin{problem}
How many degrees warmer is $100^\circ$F than $-80^\circ$F?  Begin by writing the subtraction problem.   
...
Use the figure below to rewrite the subtraction problem as an equivalent addition problem.  Then find the answer. 
...
\textcolor{orange!80!black}{Answer} $= \begin{prompt} \answer{180} \end{prompt}$ degrees
