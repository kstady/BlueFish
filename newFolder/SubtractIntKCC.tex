...
\begin{problem}
    ...
    \begin{tabular}{rcccl}
        ...
        \textbf{Rule:}     & \textcolor{red!90!black}{\textbf{KEEP}} & \textcolor{OliveGreen!90!black}{\textbf{CHANGE}} & 
        \textcolor{OliveGreen!90!black}{\textbf{CHANGE}} & \\
...
\begin{problem} 
Apply the \textbf{Keep-Change-Change} rule to rewrite the subtraction problem $-8 -(-10)$ as an equivalent addition problem. 

\[
\renewcommand{\arraystretch}{2}
\begin{array}{r @{\hskip 24pt} c @{\hskip 24pt} c @{\hskip 24pt} c}
 -8 & $-$ & (-10) \\
\textcolor{orange!80!black}{\textbf{KEEP}} & \textcolor{OliveGreen!90!black}{\textbf{CHANGE}} & \textcolor{OliveGreen!90!black}{\textbf{CHANGE}} \\
...
\[
\begin{aligned}
\textbf{Problem:} & \quad -8 \qquad\qquad - \qquad\qquad (-10) \\
\textbf{Rule:} & \quad \textcolor{orange!80!black}{\textbf{KEEP}} \qquad\quad \textcolor{OliveGreen!90!black}{\textbf{CHANGE}} \qquad \textcolor{OliveGreen!90!black}{\textbf{CHANGE}} \\
\textbf{Rewrite:} & \quad \answer{-8} \qquad\qquad \answer[format=string]{+} \qquad\qquad \answer{10}
\end{aligned}
\]
...
\begin{problem} 
Apply the Keep-Change-Change rule to rewrite the subtraction problem $-8 -(-10)$ as an equivalent addition problem. 

\begin{description}
    \item[\textbf{Problem:}] $-8 \quad - \quad (-10)$
    \item[\textcolor{orange!80!black}{\textbf{KEEP:}}] The first number stays the same: $\answer{-8}$
    \item[\textcolor{OliveGreen!90!black}{\textbf{CHANGE:}}] Change subtraction to addition: $\answer[format=string]{+}$
    \item[\textcolor{OliveGreen!90!black}{\textbf{CHANGE:}}] Change the sign of the second number: $\answer{10}$
\end{description}
