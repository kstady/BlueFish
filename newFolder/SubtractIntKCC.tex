...
\setlength{\tabcolsep}{18pt} % Adds generous horizontal spacing between columns
\begin{array}{rccc}
\textbf{Problem:} & -8 & - & (-10) \\
\textbf{Rule:} & \textcolor{orange!80!black}{\textbf{KEEP}} & \textcolor{OliveGreen!90!black}{\textbf{CHANGE}} & \textcolor{OliveGreen!90!black}{\textbf{CHANGE}} \\
\textbf{Rewrite:} & \answer{-8} & \answer[format=string]{+} & \answer{10}
\end{array}
\]
