...
\begin{problem} Apply the \textbf{Keep-Change-Change} rule to rewrite the subtraction problem $-8-10$ as an 
...
\begin{problem}
    Apply the \textbf{Keep-Change-Change} rule to rewrite the subtraction problem $-90 -(-20)$ as an equivalent 
    addition problem.  
