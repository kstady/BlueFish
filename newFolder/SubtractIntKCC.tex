...
\begin{array}{r @{\hskip 24pt} c @{\hskip 24pt} c @{\hskip 24pt} c}
 -8 \quad & - & (-10) \\
\textbf{\textcolor{glaucous}{KEEP}} & \textbf{CHANGE} & \textbf{CHANGE} \\
\answer{$-8$} & \answer[format=string]{\style{text-align: center}{+}} & \answer{10}  % Middle command makes + centered in answer box. 
\end{array}
\]
