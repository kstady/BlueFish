...
shows a subtraction sign changing to an addition sign.  A second arrow points to the third box, labeled CHANGE, 
which shows negative ten changing to positive ten.  Below the boxes, the final transformed expression is written as: 
negative sixty plus ten equals negative fifty.}
\end{center}
...
\begin{align*}
\textbf{Problem:} && -8 && - && (-10) \\
\textbf{Rule:} && \textcolor{red!90!black}{\textbf{KEEP}} && \textcolor{OliveGreen!90!black}{\textbf{CHANGE}} && \textcolor{OliveGreen!90!black}{\textbf{CHANGE}} \\
\textbf{Rewrite:} && \answer{-8} && \answer[format=string]{+} && \answer{10}
\end{align*}
