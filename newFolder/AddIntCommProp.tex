...
\begin{example}  
    ...
    Add the negative numbers $-6$ and $-4,$ then add the positive numbers $3$ and $1.$  
    \begin{center}
        \begin{tikzpicture}[
...
4 plus 1.  A blue line  onnects the negative 6 and negative 4 with the label ''Add Negatives''.  
An orange line connects positive 3 and 1 with the label ''Add Positives''.  Dashed arrows show these 
groups simplifying on the right side to negative 10 plus 4.  Below this step, the final line shows 
an equals sign pointing to the simplified result negative 6.}
\end{center}
\end{explanation}
\end{example}
