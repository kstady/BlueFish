...
\[ \textbf{Fraction Shaded } = \frac{\answer{3}}{\answer{10}}  \]
...
%This works too:  \hspace*{10em} 
\begin{itemize}
        \item \textbf{Example}: $\frac{7}{12}$
\end{itemize}
...
{
\renewcommand{\labelenumi}{(\alph{enumi})}  %Forces labels (a), (b),...
\begin{enumerate}
...
\begin{problem}  Identify the position of the letter $A$ on the number line.
