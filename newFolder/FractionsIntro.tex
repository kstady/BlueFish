...
of the square is shaded because the parts are not the same size.  To correct this, we redraw the lines so that every part is the exact same size, as shown in the CORRECT square on the right.
