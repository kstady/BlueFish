...
Since $\textstyle \frac{1}{3}$ is \emph{added} to $\textstyle \frac{1}{2},$ the result should be greater than $\textstyle \frac{1}{2}.$  However, the student's answer of $\textstyle \frac{2}{5}$ is actually less than $\textstyle \frac{1}{2}.$  This shows that simply adding the numerators and denominators doesn't work!  To get the correct answer, we need to divide each whole so that the pieces match.
