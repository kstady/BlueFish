...
To find the sum $-5+3,$ begin with \textcolor{blue!70!black}{\textbf{five blue rods}} to represent the number $-5$ and \textcolor{orange!85!black}{\textbf{three orange rods}} to represent the number $3.$  Next remove all pairs of orange and blue rods.  Since two blue rods remain, the answer is $-2.$
