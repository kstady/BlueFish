...
\title{Adding Integers With a Numberline}   % Use xmlatex all -s to compile when SERVE refuses to work.
\author{Kelly Stady}
...
\begin{example}
To find the value of $3+7,$ start at $3$ then move 7 units to the \textbf{right}.  Movement is to the right, since a \textbf{positive} number is added to 3.
