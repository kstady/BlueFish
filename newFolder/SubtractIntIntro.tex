...
\begin{center} 
\begin{tikzpicture}[scale=0.35] % Reduced scale so the 16.7 height fits nicely on screen
...
% Villingili Island Point (+16.7) - NOW MATCHES MATHEMATICALLY
...
% Total Span Arrow
\draw[<->, orange!80!black, line width=2pt] (-6,0) -- (-6,16.7) node [midway, left=15pt, align=center] {\Large\textbf{Elevation}\\\Large\textbf{Span}}; 

% Guides 
\draw[dashed, gray, thick] (-6,16.7) -- (0,16.7); 
\draw[dashed, gray, thick] (-6,0) -- (0,0); 
