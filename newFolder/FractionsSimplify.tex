...
\label{xim:FractionsSimplifyActivity}

\section*{Introduction}

To simplify fractions, we first need to understand some facts about \textbf{counting numbers} (also called \textbf{natural numbers}) and \textbf{whole numbers}.
...
\textbf{True or False}:  All prime numbers are odd, except for 2.
...
We will consider two methods for finding the GCF.


\textbf{Method I}:  List the factors of each number and look for the largest number that appears in each list.  For example, to find the GCF of 12 and 36 we begin by listing the factors of each number.
...
\textbf{Method II:} Find the prime factorization of the numbers and multiply the common prime factors.  For example, to find the GCF of 12 and 36 using this approach we begin with the prime factorization of both numbers.


\qquad  $12 = 2 \cdot 2 \cdot 2 \cdot 3$

\qquad  $36 = 2 \cdot 2 \cdot 3 \cdot 3$


The common factors are 2 and 3.  There are two factors of 2 and one factor of 3 in \textit{both} factorizations, so the GCF = $2 \cdot 2 \cdot 3$ which equals 12.
...
\begin{problem}
  You are creating identical goodie bags for a school event. You have:
  \begin{itemize}
      \item \textbf{18} Airheads
      \item \textbf{24} Tootsie Rolls
      \item \textbf{36} Kit-Kats
  \end{itemize}

  What is the \textbf{greatest} number of identical goodie bags you can make if you use all the candy and leave nothing over?
...
\begin{problem}
  ...
  The carpenter needs to cut all three boards into smaller pieces of equal length so that there is no scrap wood left over. What is the longest possible length for these pieces?
...
\begin{problem}
  Based on the problem above, how many 4-foot pieces will the carpenter have after cutting all three boards?
...
\textbf{Method I:} Divide the numerator and denominator by the GCF.
...
\begin{problem}
  ...
  \begin{feedback}
    Divide both the numerator and the denominator by the GCF (12):
    \[ 24 \div 12 = 2 \]
    \[ 36 \div 12 = 3 \]
  \end{feedback}
\end{problem}
...
\begin{problem}
  ...
  \begin{hint}
    List the factors for each number to find the largest one they share:
    \begin{itemize}
        \item Factors of 18: 1, 2, 3, 6, \textbf{9}, 18
        \item Factors of 45: 1, 3, 5, \textbf{9}, 15, 45
    \end{itemize}
  \end{hint}
\end{problem}


\textbf{Method II:} Write the prime factorization of the numbers in the numerator and denominator, then cancel the common prime factors.
