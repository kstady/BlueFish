...
may not make sense to include 0.  Whole numbers are used when 0 is needed to represet a starting point or the total absence of something, while
counting numbers are used when a concept requires at least one of something to exist.  
...
%is useful when we discuss concepts and mathematical rules.  


\begin{problem}
For each scenario below, determine whether the set of \textbf{counting numbers} or the set of \textbf{whole numbers} is the most appropriate to use.

\begin{enumerate}
\begin{problem}
\item \textbf{Rankings in a race}: Identifying the top 3 winners in a race.
\begin{multipleChoice}
    \choice[correct]{Counting numbers}
    \choice{Whole numbers}
\end{multipleChoice}
\begin{feedback}
    Correct! There is no such thing as a 0th place in a race. The winners are 1st, 2nd and 3rd.
\end{feedback}
\end{problem}

\begin{problem}
\item \textbf{Points scored in a basketball game}: Tracking the total score for a team.
\begin{multipleChoice}
    \choice{Counting numbers}
    \choice[correct]{Whole numbers}
\end{multipleChoice}
\begin{feedback}
    Correct! A team can be held to 0 points (a shutout).
\end{feedback}
\end{problem}

\begin{problem}
\item \textbf{Defining Polygons}: Stating how many sides a specific geometric shape has.
\begin{multipleChoice}
    \choice[correct]{Counting numbers}
    \choice{Whole numbers}
\end{multipleChoice}
\begin{feedback}
    Correct! A shape cannot have 0 sides; it must have at least 3 sides to be a polygon.
\end{feedback}
\end{problem}

\begin{problem}
\item \textbf{Store Inventory}: Keeping track of how many laptops are left in stock.
\begin{multipleChoice}
    \choice{Counting numbers}
    \choice[correct]{Whole numbers}
\end{multipleChoice}
\begin{feedback}
    Correct! If a store sells out of an item, the inventory count is 0.
\end{feedback}
\end{enumerate}
\end{problem}
...
\end{multipleChoice}
\begin{feedback}
    Correct! While $6 \times 6 = 36$, we only list the number 6 once when writing out the set of factors.
\end{feedback}
\end{problem}
...
\begin{problem}
Simplify the fraction using the prime factorizations.
