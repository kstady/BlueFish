...
\begin{flushleft}
\hspace{10em} % This creates horizontal indent, but not enough! Changing the number doesn't help
$\begin{aligned}
...
Notice that the only difference between these two sets of numbers is 0.  While these sets are almost identical, having distinct names 
is useful when we discuss concepts and mathematical rules because sometimes we want to include 0 and sometimes we don't.  
...
\item[Step 2] \textbf{Evaluate Each Factor}: \begin{itemize}
...
\item[Step 1] \textbf{Find a Pair of Factors}:  \ The numbers 6 and 11 have a product of 66. cna
