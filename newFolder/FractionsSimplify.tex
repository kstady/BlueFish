...
\begin{problem} \textcolor{glaucous!75!black}{\textbf{True or False}}:  The GCF will always be less than or equal to the smallest number in the group.
...
\begin{problem}
  ...
  \[ \textrm{Greatest number of bags } = \answer{6} \] 
