...
\begin{problem}
  Simplify the fraction $\displaystyle \frac{18}{45}.$
...
Write the prime factorization of the numbers in the numerator and denominator, cancel the common prime factors then multiply the 
remaining numbers in the numerator and denominator to find the result.
...
Write the prime factorization of each number, cancel the common factors, then multiply the remaining numbers in the numerator and denominator
to find the result. 
