...
Begin by writing the prime factorization of each number.  Then divide the common factors. Note that $\frac{5}{5}=1$ then multiply the remaining numbers in the numerator and denominator
to find the result. 
