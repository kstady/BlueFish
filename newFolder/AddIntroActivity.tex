...
\title{Introduction to Adding Integers}   % Use xmlatex all -s to compile when SERVE refuses to work.
\author{Kelly Stady}
...
% --- SECTION 1: THE SETUP (Lined up vertically) ---
    ...
    \begin{scope}[shift={(0,0)}]
        ...
        \node[darkraspberry, font=\bfseries, align=center] at (0.9, -1.35) {No Pairs to Remove!};
