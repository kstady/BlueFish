...
% --- SECTION 1: THE SETUP (Lined up vertically) ---
    ...
    \begin{scope}[shift={(0,0)}]
        ...
        \node[black, font=\bfseries\small, align=center] at (0.9, -1.35) {No Pairs to Remove!};
...
% Transition arrow  %The answer box doesn't appear within the tikz pic, so I moved it out. 
