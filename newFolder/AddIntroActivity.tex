...
% --- SECTION 1: THE SETUP ---
    ...
    % Bottom equation
    \node[anchor=north, black!80, font=\bfseries] at (-5, -5) {$-5 + 3 = -2$};
...
% --- SECTION 3: THE RESULT ---
    ...
    \node[font=\bfseries\small] at (0.6, 2.2) {Result};
...
\begin{example} To find the sum $-5+3,$ begin with \textbf{five $-$ signs} to represent the number $-5$ and \textbf{three $+$ signs} to represent the number $3.$  Next remove all $+$ $-$ pairs.  Since two $-$ signs remain, the answer is $-2.$
