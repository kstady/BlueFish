...
\begin{problem} \textcolor{ximeraorange!80!black}{\textbf{True or False}}:  The GCF will always be less than or equal to the smallest 
    number in the group.
...
\begin{problem}
  You are creating identical goodie bags for a party. You have \textbf{18} Airheads, \textbf{24} Tootsie Rolls and
