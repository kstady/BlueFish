...
\begin{problem} \textcolor{funkyolive}{\textbf{True or False}}:  The GCF will always be less than or equal to the smallest 
    number in the group.

    \textcolor{darkraspberry}{\textbf{True or False}}:  The GCF will always be less than or equal to the smallest 
    number in the group.
...
Find the GCF of 12 and 36 using the prime factorizations. 
