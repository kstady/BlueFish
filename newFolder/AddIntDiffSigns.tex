...
\hspace{0.5in}  \textbf{The answer is positive, so the positive team win!}
...
\hspace{0.5in}  \textbf{The answer is negative, so the negative team win!}
...
\begin{Steps for Adding Integers with Different Signs}
...
\end{enumerate}
\end{Steps for Adding Integers with Different Signs}
