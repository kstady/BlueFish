...
\textcolor{glaucous}{\textbf{Battle 1:}}  \ If you have \$30 and spend \$20 to see a movie, your net balance is \$10. 
...
\textcolor{glaucous}{\textbf{Battle 2:}} \ If you have \$30 and a credit card debt of \$100, your net balance is a debt of \$70.
...
\textcolor{glaucous}{\textbf{Battle 1:}} \ $30 + (-20) = 10$  
\begin{itemize}
...
\textcolor{glaucous}{\textbf{Battle 2:}} \ $30 + (-100) = -70$
\begin{itemize}
    \item[] The strength of the \$30 asset is $|30| = 30$.
...
As noted earlier, adding numbers with different signs is a bit of a paradox: to find the sum, 
...
\begin{problem}
    ...
    \textcolor{orange!80!black}{\textbf{Final Answer:}} \ $15 + (-40) = \answer{-25}$
...
\textcolor{orange!80!black}{\textbf{Charge}} $= \answer{-5}$
\end{problem}



% PROBLEM 1: The Gender Wage Gap (Negative + Positive)
\begin{problem}
Due to systemic gender wage disparities, a female researcher discovers she is historically underpaid by $4500$ dollars 
per year compared to her male peers.  After a successful union contract negotiation, the organization passes an equity 
adjustment that adds $6000$ dollars ($+6000$) to her annual salary.

What is her new salary balance relative to her peers?
\[ -4500 + 6000 = \answer{1500} \]
\end{problem}


% PROBLEM 2: Repatriation of Indigenous Land (Negative + Positive)
\begin{problem}
Over generations of forced displacement, a Native Indian nation's historic reservation land area was reduced 
by $1200$ square miles. Through a modern ''Land Back'' tribal sovereignty initiative, the local government 
returned $350$ square miles ($+350$) of ancestral territory back to the nation.

What is the net change in the nation's land area relative to their historic boundaries?
\[ -1200 + 350 = \answer{-850} \]
\end{problem}


% PROBLEM 3: Environmental Cleanup of a Polluted River (Positive + Negative)
\begin{problem}
A chemical manufacturing plant illegally dumped toxic waste into a public river ecosystem, 
leaving the water quality index at a dangerously high pollution level of $85$ parts per million 
($+85$). Following a community-led environmental justice protest, the city installs a modern 
filtration grid that successfully removes $95$ parts per million ($-95$) of the toxins.

What is the new water quality index level relative to the starting safety baseline?
\[ 85 + (-95) = \answer{-10} \]
\end{problem}
