...
\begin{note}
A statement such as ``a debt of \$50'' is represented mathematically as $-50$. The negative sign is omitted in the phrase because the word \emph{debt} already implies a negative value.
\end{note}

\bigskip

\begin{warning}
A common mistake is to think that $-4 + (-3)$ equals a positive $7$. Remember, combining two negative quantities always results in a more negative value!
\end{warning}
