...
\hspace{1.5in} \textbf{The answer is positive, so the positive team win!}
...
\hspace{1.5in} \textbf{The answer is negative, so the negative team win!}
...
\begin{enumerate}[topsep=10pt] % Adjust 10pt up or down until it looks right
