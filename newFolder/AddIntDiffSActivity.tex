...
\hspace{2in} \textbf{The answer is positive, so the positive team win!}
...
\hspace{2in} \textbf{The answer is negative, so the negative team win!}
...
\begin{enumerate}[topsep=15pt] % Adjust 10pt up or down until it looks right
