...
\begin{problem}
Atoms are the tiny building blocks of all matter.  An atom consists of protons, neutrons and electrons.    
Each proton has a positive charge ($+1$), neutrons have no charge (0) and each electron has a negative charge
($-1$).  Chemists find the charge of an atom by adding the charges of its electrons and protons.  Write the addition 
