...
\hspace{3in} \textbf{The answer is positive, so the positive team win!}
...
\hspace{3in} \textbf{The answer is negative, so the negative team win!}
...
\begin{description}[style=multiline, leftmargin=5em, font=\bfseries]
    ...
    First, we determine the strength of each number.
...
real numbers—more on that later.

Because you’ve mastered these addition rules, you are now ready for subtraction. As you'll see in the next lesson, \textbf{if you can add integers, you can subtract them too!}

Did you know that there are infinitely many numbers between each integer?
