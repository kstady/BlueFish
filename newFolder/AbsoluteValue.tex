...
\begin{tikzpicture}[>=stealth, scale=1.2]
    ...
    % Equation centered above the text node
    \node[align=center] at (1.5, -0.2)
    {\textbf{Speed} \ = \ |\textrm{Velocity}|};

    % Text node centered below the equation
    \node[draw=black!70, rounded corners, fill=gray!8, text width=7cm, align=center] at (1.5, -1)
    {Speed is the \textbf{magnitude} or \textbf{size} of velocity.};

\end{tikzpicture}
\xmalt{A diagram showing the mathematical relationship between speed and velocity. At the top, the equation 'Speed equals the absolute value of Velocity' is displayed. Below it, a light gray box contains the text: 'Speed is the magnitude or size of velocity.}
\end{center}
