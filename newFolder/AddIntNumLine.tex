...
\end{tikzpicture}
\xmalt{Horizontal number line from negative 5 to 10, with tick marks and labels for each integer.  There is a solid black dot at 
$3$ and the word 'Start' is written in green below it.  A series of connected, arched blue curves move 
to the right from 3, landing on each integer until stopping at 10, with an arrow pointing to 10. The word 'Stop' is written in 
orange below the number 10.  The equation "3 plus 7 equals 10" is displayed centered above the arches.}
...
\xmalt{Horizontal number line from negative 5 to 10, with tick marks and labels for each integer.  There is a solid black dot at 
$3$ and the word 'Start' is written in green below it. A series of connected, arched blue curves move 
leftward from 3, landing on each integer until stopping at negative 4, with an arrow pointing to negative 4.  The word 'Stop' is
written in orange below negative 4.  The equation "3 plus negative 7 equals negative 4" 
is displayed centered above the arches.}
\end{center}
