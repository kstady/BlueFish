...
\begin{example}
    ...
    \textcolor{glaucous}{\textbf{Combining Assets:}} If a child has \$100 ($+100$) in her piggy bank and receives \$30 ($+30$) for doing her chores, her net 
...
\begin{example}
    ...
    Combining Debts: If you have a credit card debt of \$500 ($-500$) and make another credit card purchase of 
...
\begin{example}
    ...
    \textbf{Partial Cancellation:} If you have \$20 ($+20$) and owe a friend \$25 ($-25$). Your \$20 isn't enough to 
...
\begin{example}
    ...
    \textbf{Full Cancellation:} If a taxpayer owes the IRS \$300 ($-300$) and has \$800 ($+800$) in the bank, they can pay the 
...
Find your net balance.  

\textcolor{glaucous}{\textbf{Net Balance}} = $\answer{-65}$
...
Find the team's net balance.  

\[ \textrm{\textcolor{glaucous}{\textbf{Net Balance}}}= \answer{150} \]
...
find your net balance after you use your gift money toward the rent.
