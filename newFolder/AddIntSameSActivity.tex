...
\begin{description}[style=multiline, leftmargin=5em, font=\bfseries]
    ...
    Since both numbers were negative, the answer is negative.
    \[ -50 + (-30) = -80 \]
\end{description}
...
\begin{problem}
    ...
    \begin{problem}
    \textbf{Step 2:} \textbf{Add} the absolute values (Join forces):
    \[ 15 + 40 = \answer{55} \]

    \begin{problem}
    \textbf{Step 3:} Write the answer with the common sign:
