...
\renewcommand{\arraystretch}{1.8} % Extra height for touch-friendly mobile rows
\[
\rowcolors{2}{glaucous!15}{white}
\begin{array}{l p{0.15\textwidth} l}
\rowcolor{glaucous!30}
\text{\large \textbf{Role}} & \text{\large \textbf{Example}} & \text{\large \textbf{How to Read It}} \\
\hline
\text{\textbf{Negative}} & -8 & \text{``Negative 8''} \\
\text{\textbf{Opposite}} & -(-8) & \text{``The opposite of negative 8''} \\
\text{\textbf{Opposite}} & -(5) & \text{``The opposite of 5''} \\
\text{\textbf{Opposite}} & -|6| & \text{``The opposite of the absolute value of 6''} \\
\text{\textbf{Opposite}} & -x & \text{``The opposite of } x\text{''} \\
\text{\textbf{Subtraction}} & 10 - 8 & \text{``10 minus 8''} \\
\end{array}
\]
