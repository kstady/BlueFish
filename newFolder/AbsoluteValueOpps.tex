...
\end{tikzpicture}
\xmalt{A horizontal number line from negative 5 to 5 with solid dots plotted at -4, 0, and 4.  Above the line, an 
...
\end{tikzpicture}
\xmalt{A physics diagram illustrating vertical projectile motion relative to a ground line.  A ball is shown near the 
...
used for \textbf{grouping}, whereas \textbf{absolute value} is an \textbf{operation}.
