...
\hline
\rule{0pt}{4ex} $-15$ & $\answer{15}$ & $\answer{15}$ \\
\rule{0pt}{4ex} $8$ & $\answer{-8}$ & $\answer{8}$ \\
\rule{0pt}{4ex} $0$ & $\answer{0}$ & $\answer{0}$ \\
\rule{0pt}{4ex} $-2.5$ & $\answer{2.5}$ & $\answer{2.5}$ \\
\end{tabular}
...
\begin{array}{ccc}
\text{\large\textbf{Number}} & \text{\large\textbf{Opposite}} & \text{\large\textbf{Absolute Value}} \\
\hline
