...
\begin{center}
\renewcommand{\arraystretch}{2} % Increased slightly to give the dropdowns vertical room
\begin{tabular}{l @{\hspace{2em}} l} % Left-align and force a specific 2-character gap
\textbf{Expression} & \textbf{How to Read It} \\ 
\hline
$18 - 5$ & \wordChoice{\choice{Negative 5} \choice[correct]{Eighteen minus five} \choice{The opposite of 5}} \\ 
...
$-|-7|$ & \wordChoice{\choice[correct]{The opposite of the absolute value of negative 7} \choice{The opposite of the absolute value of 7} \choice{The absolute value of negative 7}} \\ 
