...
length is off by no more than $\textstyle \frac{1}{4}$ inch of the target.  Suppose you cut the first board $35.8$ inches long.  The 
...
Is this board usable? \textbf{Hint}: A board is usable if the absolute error is less than or equal to $\textstyle \frac{1}{4} = 0.25$
...
\renewcommand{\arraystretch}{1.8} % Adds space between rows. Value of 1.5 or 2 are good. This multiples the default row height by 1.5, 2, etc.
\begin{center}
\begin{tabular}{ccc}
...
\definecolor{glaucous}{HTML}{6082B6} % Define glaucous using hex code

\renewcommand{\arraystretch}{1.5}
% \rowcolors{start_row}{odd_row_color}{even_row_color}
\rowcolors{2}{glaucous!15}{white} 

\begin{tabular}{p{0.2\textwidth} p{0.15\textwidth} p{0.5\textwidth}}
\rowcolor{glaucous!30} % Header remains darker for contrast
...
\renewcommand{\arraystretch}{2} % Adds vertical breathing room
\begin{tabular}{|l|c|l|}
