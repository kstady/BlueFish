...
\begin{example}
    ...
    Below are some examples of how we read expressions with dashes. 

    ` \\[1em]
    
    \textbf{Negative 8}:  \ $-8$
    
    \textbf{The opposite of negative 8}:  $-(-8)$  

    \textbf{The opposite of 5}: \  $-(5)$

    \textbf{The opposite of the absolute value of $6$}: \ $-|6|$
    
    \textbf{The opposite of $x$}: \ $-x$
    
    \textbf{10 minus 8}: \ $10 - 8$
