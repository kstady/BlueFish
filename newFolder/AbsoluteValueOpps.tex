...
\begin{example}
    ...
    \begin{center}
$\begin{aligned}
    &\text{\textbf{\textcolor{glaucous}{Expression}}} && \quad \text{\textbf{\textcolor{glaucous}{How to Read It}}} \\[2.5ex]
    &-8 && \quad \text{``Negative 8''} \\[1.8ex]
    &-(-8) && \quad \text{``The opposite of negative 8''} \\[1.8ex]
    &-(5) && \quad \text{``The opposite of 5''} \\[1.8ex]
    &-|6| && \quad \text{``The opposite of the absolute value of 6''} \\[1.8ex]
    &-x && \quad \text{``The opposite of } x \text{''} \\[1.8ex]
    &10 - 8 && \quad \text{``10 minus 8''}
\end{aligned}$
\end{center}
