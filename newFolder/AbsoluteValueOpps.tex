...
\begin{example}
    ...
    The opposite of negative 8:  $-(-8)$ 


\begin{description}[leftmargin=3em, style=nextline, font=\normalfont]
    \item[\textbf{\textcolor{glaucous}{Expression}}] \textbf{\textcolor{glaucous}{How to Read It}} \vspace{1ex}
    
    \item[$-8$] \hspace*{1in} ``Negative 8'' \vspace{1ex}
    
    \item[$-(-8)$] \hspace*{1in} ``The opposite of negative 8'' \vspace{1ex}
    
    \item[$-(5)$] \hspace*{1in} ``The opposite of 5'' \vspace{1ex}
    
    \item[$-|6|$] ``The opposite of the absolute value of $6$'' \vspace{1ex}
    
    \item[$-x$] ``The opposite of $x$'' \vspace{1ex}
    
    \item[$10 - 8$] ``10 minus 8''
\end{description}
...
\item $-(-12)$ is read as \wordChoice{\choice{Negative negative 12} \choice{Minus negative 12} \choice[correct]{The opposite of negative 12}}. \\ 
