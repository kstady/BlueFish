...
\setlength{\arraycolsep}{20pt} % Increases horizontal space between columns
\begin{array}{ccc}
\text{\textbf{Number}} & \text{\textbf{Opposite}} & \text{\textbf{Absolute Value}} \\
\hline
...
\large \textbf{\textcolor{glaucous}{Role}} & \large \textbf{\textcolor{glaucous}{Example}} & \large \textbf{\textcolor{glaucous}{
    How to Read It}} \\
