...
To find the opposite of the absolute value of negative 7, start with the absolute value: $|-7| = 7,$ then find the opposite of that result.  
The opposite of 7 is $-7$ therefore,
...
While absolute value always results in a nonnegative (zero or positive) number, taking the opposite of a number flips its sign. 
Therefore, an opposite can be positive, negative or 0. Note that for the number 0, both its absolute value and its opposite are 0.
...
\begin{problem}
\textcolor{glaucous!75!black}{\textbf{True or False}}: \ If a number is negative, its opposite must be positive.
...
\begin{problem}
\textcolor{glaucous!75!black}{\textbf{True or False}}: \ Two different numbers can have the same absolute value.
