...
\begin{problem}
\textcolor{ximeraorange}{\textbf{True or False}}: If a number is negative, its opposite must be positive.
...
\begin{problem}
\textcolor{ximeraorange}{\textbf{True or False}}: Two different numbers can have the same absolute value.
