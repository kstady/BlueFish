...
\large
$\begin{alignedat}{2}
    &\text{\textbf{\textcolor{glaucous}{Expression}}} && \hspace{2em} \text{\textbf{\textcolor{glaucous}{How to Read It}}} \\[2ex]
    &-8 && \text{``Negative 8''} \\[1.5ex]
    &-(-8) && \text{``The opposite of negative 8''} \\[1.5ex]
    &-(5) && \text{``The opposite of 5''} \\[1.5ex]
    &-|6| && \text{``The opposite of the absolute value of 6''} \\[1.5ex]
    &-x && \text{``The opposite of } x \text{''} \\[1.5ex]
    &10 - 8 && \text{``10 minus 8''}
\end{alignedat}$
\end{center}
