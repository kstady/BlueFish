...
\large
$\begin{aligned}
    &\textbf{\textcolor{glaucous}{Expression}} && \textbf{\textcolor{glaucous}{How to Read It}} \\[1ex]
    &-8 && \text{``Negative 8''} \\
    &-(-8) && \text{``The opposite of negative 8''} \\
    &-(5) && \text{``The opposite of 5''} \\
    &-|6| && \text{``The opposite of the absolute value of 6''} \\
    &-x && \text{``The opposite of } x \text{''} \\
    &10 - 8 && \text{``10 minus 8''}
\end{aligned}$
\end{center}
