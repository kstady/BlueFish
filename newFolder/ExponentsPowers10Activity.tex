...
\textbf{Base} $\begin{prompt}=\answer{10}\end{prompt}$  \hspace{0.5in}  \textbf{Exponent} $\begin{prompt}=\answer{7}\end{prompt}$
...
\begin{problem} A greedy CEO demanded a pay package worth \$1 trillion, which is equal to $10^{12}.$  Write the value of $10^{12}.$
