...
\begin{tikzpicture}[scale=0.4]
    ...
    \draw[thick, fill=blue!5] (2.2,0) circle (0.8);
    % Bridge (Land exactly at the edge of the next lens: 2.2 - 0.8 = 1.4)
    \draw[thick] (0.8,0.1) arc (160:20:0.32);
    % Temples (Arms)
    \draw[thick] (-0.8,0.3) -- (-1.6,0.6);
    \draw[thick] (3,0.3) -- (3.8,0.6);
\end{tikzpicture}
