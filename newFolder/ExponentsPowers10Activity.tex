...
Below are the first three positive powers of 10.  \textbf{Notice that the exponent in each power of 10 is the same as the number of zeros in the result}.  In general, if $n$ is a positive integer, then the value of $10^n$ is the number 1 followed by $n$ zeros.  For example, below you can see that $10^3$ equals the number 1 followed by 3 zeros.
\begin{eqnarray*}
