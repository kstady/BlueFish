...
\hspace{4in} \textbf{Base} $\begin{prompt}=\answer{10}\end{prompt}$  \hspace{1in}  \textbf{Exponent} $\begin{prompt}=\answer{7}\end{prompt}$
...
\hspace{3in} \textbf{Base} $\begin{prompt}=\answer{4}\end{prompt}$  \hspace{1in}  \textbf{Exponent} $\begin{prompt}=\answer{5}\end{prompt}$
